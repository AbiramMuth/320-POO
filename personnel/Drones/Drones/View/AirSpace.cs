namespace Drones
{
    ...
    public partial class AirSpace : Form
    {
        ...
        public AirSpace(List<Drone> fleet, List<Building> numberBuilding, List<Factory> nbrFactory, List<Store> nbrStore, List<Box> nbrBox)
        {
            InitializeComponent();
